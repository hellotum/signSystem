                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                    ...
                                    <form class="form-horizontal form-signin" role="form" method="post" action="../addtodatabase/addActivict.php" enctype="multipart/form-data"  onsubmit="return Check()">
                                        <!-- 活动名称 BEGIN-->
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <i class="icon-asterisk red"></i>活动名称 </label>

                                            <div class="col-sm-9">
                                                <input type="text" name="name" id="name" placeholder="请输入活动名称" class="col-xs-12 col-sm-5" />
                                            </div>
                                        </div>
                                        <!-- 活动名称 END-->
                                        ...
                                        <!-- 标题展览大图 BEGIN-->
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 标题展览大图(可单选默认图) </label>

                                            <div class="col-sm-4 col-xs-12">
                                                <input type="file" name="img" id="id-input-file-2"  onchange="loadImage(this)" value="xxx" />
                                        ...
                                        <div class="space-4"></div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 临时群二维码 </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="address" id="address" placeholder="请输入活动地点" class="col-xs-12 col-sm-5" />
                                            </div>
                                        </div>
                                        <!-- 活动地点 END-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="person" id="person" placeholder="请输入活动联系人" class="col-xs-12 col-sm-5" />
                                            </div>
                                        </div>
                                        <!-- 活动联系人 END-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="tel" name="tel" id="tel" placeholder="请输入活动联系人电话"  pattern="^1[3458]{1}[0-9]{9}$" class="col-xs-12 col-sm-5" />
                                            </div>
                                        </div>
                                        <!-- 活动联系人电话 END-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-2 col-xs-12">
                                                <input class="form-control date-picker" id="id-date-picker-1" type="text" name="timeBegin" data-date-format="yyyy-mm-dd" placeholder="请选择初始日期"/>
                                            ...
                                            <div class="input-group col-md-2 col-xs-12 bootstrap-timepicker">
                                                <input id="timepicker1" type="text" class="form-control" name="timeBegin2" placeholder="请选择初始时间"/>
                                                <span class="input-group-addon">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-2 col-xs-12">
                                                <input class="form-control date-picker" id="id-date-picker-2" type="text" name="timeEnd" data-date-format="yyyy-mm-dd" placeholder="请选择结束日期"/>
                                                <span class="input-group-addon">
                                            ...
                                            <!-- 时间选择器 -->
                                            <div class="input-group col-md-2 col-xs-12 bootstrap-timepicker">
                                                <input id="timepicker2" type="text" class="form-control" name="timeEnd2" placeholder="请选择结束时间"/>
                                                <span class="input-group-addon">
                                                    <i class="icon-time bigger-110"></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- 日期选择器 -->
                                            <div class="input-group col-md-2 col-xs-12">
                                                <input class="form-control date-picker" id="id-date-picker-3" type="text" name="signTime" data-date-format="yyyy-mm-dd" placeholder="请选择报名截止时间"/>
                                                <span class="input-group-addon">
                                                    <i class="icon-calendar bigger-110"></i>
                                                </span>
                                            </div>
                                            ...
                                            <div class="input-group col-md-2 bootstrap-timepicker col-xs-12">
                                                <input id="timepicker3" type="text" class="form-control" name="signTime2" placeholder="请选择初始时间"/>
                                                <span class="input-group-addon">
                                                    <i class="icon-time bigger-110"></i>
                                                </span>
                                            </div>
                                        ...
                                        <!-- 报名上限 BEGIN-->
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><i class="icon-asterisk red"></i>报名上限 </label>

                                            <div class="col-sm-1">
                                                <input type="number" name="number" id="number" class="col-xs-12 col-sm-12" size="4" min="1" max="9999"/>
                                            </div>
                                        </div>
                                        <!-- 报名上限 END-->
...
//                }
        ...
        function checkFileExt(ext) {
            if (!ext.match(/.jpg|.gif|.jpeg|.png|.bmp/i)) {
                return false;
            }
            return true;
        }  
