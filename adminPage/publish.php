                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                <button class="btn btn-info" type="button"  data-toggle="modal" data-target=".bs-example-modal-sm" title="确认发布该活动">
                                                                ...
                                                                <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                                                                  <div class="modal-dialog modal-sm" role="document">
                                                                    <div class="modal-content">
                                                                      <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                        <h4 class="modal-title" id="publish">发布活动</h4>
                                                                      </div>
                                                                      <div class="modal-body">
                                                                       是否发布<b><?php echo $row['activityName']; ?></b>这个未活动？
                                                                      </div>
                                                                      <div class="modal-footer">
                                                                        <button type="button" class="btn btn-default" data-dismiss="modal">取消发布</button>
                                                                        <a class="btn btn-primary" href="<?php echo $publish;?>">确认发布活动</a>
                                                                      </div>
                                                                    </div>
                                                                  </div>
                                                                </div>
                                                                ...
                                                                <div class="inline position-relative">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="<?php echo $publish;?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                                <span class="btn-primary" title="发布活动">
